...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#61719@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#61719@#permission"?: PermissionStatus;
    "__#61719@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#61719@#error": Error;
    readonly error: Error;
    "__#61719@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#61719@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#39021@#private": any;
