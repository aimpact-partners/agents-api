...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#48306@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#48306@#permission"?: PermissionStatus;
    "__#48306@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#48306@#error": Error;
    readonly error: Error;
    "__#48306@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#48306@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#25386@#private": any;
