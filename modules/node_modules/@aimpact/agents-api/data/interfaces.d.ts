...
declare namespace ns_0 {
  import IUserBase = ns_8.IUserBase;
...
declare namespace ns_3 {
  ...
  export interface IAgentsBase extends IPromptBase {
    literals: {
  ...
  export interface IAgentsData extends IAgentsBase {}
}
...
export import IIPEBase = ns_3.IIPEBase;
export import IIPEData = ns_3.IIPEData;
export import IAgentsBase = ns_3.IAgentsBase;
export import IAgentsData = ns_3.IAgentsData;
...
export import ISchemaBase = ns_7.ISchemaBase;
export import ISchemaData = ns_7.ISchemaData;
export import ISchemaLanguageBase = ns_7.ISchemaLanguageBase;
export import ISchemaLanguageData = ns_7.ISchemaLanguageData;
export import IUserBase = ns_8.IUserBase;
export import IUserData = ns_8.IUserData;
